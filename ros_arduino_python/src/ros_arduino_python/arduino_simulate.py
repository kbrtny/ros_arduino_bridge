...
class ArduinoSimBus(Arduino):
    def __init__(self, port = 0):
        ...
        '''
        #Simulated Arduino:
        self.base = None  # to trick simulated arduino
        '''
        
        self.servo_pos = [45, 45]
    ...
    '''
    def base_for_simulation(self, base):
        #: Give the simulated arduino a copy
...
if __name__ == "__main__":
    myArduino = ArduinoSimBus(port = 0)
    myArduino.connect()
    ...
    print "Drive motor 1..."
    myArduino.drive(100,0)
    time.sleep(2.0)
    print "Drive motor 2..."
    myArduino.drive(0,100)
    time.sleep(2.0)
    myArduino.drive(0,0)

    print "Encoder counts:",myArduino.get_encoder_counts()

    print "Battery in millivolts:",myArduino.analog_read(106)
    ...
    print "Move servoes:"
    left_srv, rght_srv = myArduino.servo_read(0), myArduino.servo_read(1)
    print "Servos: left = ", left_srv, " right = ", rght_srv
    myArduino.servo_write(0, 120)
    myArduino.servo_write(1, 60)
    time.sleep(1.0)
